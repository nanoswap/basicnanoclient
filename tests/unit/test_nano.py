...
class TestBasicNanoClient(unittest.TestCase):
    ...
    def test_key_expand(self, mock_post):
    ...
    @patch('requests.Session.post')
    def test_wallet_create(self, mock_post):
        self.mock_response.json.return_value = {
    ...
    @patch('requests.Session.post')
    def test_accounts_create(self, mock_post):
        self.mock_response.json.return_value = {
    ...
    @patch('requests.Session.post')
    def test_receive(self, mock_post):
        self.mock_response.json.return_value = {
            "block": "sample_block"
        }
        mock_post.return_value = self.mock_response

        response = self.client.receive("sample_wallet", "sample_account", "sample_block")
        self.assertEqual(response["block"], "sample_block")

    @patch('requests.Session.post')
    def test_account_info(self, mock_post):
        self.mock_response.json.return_value = {
    ...
    @patch('requests.Session.post')
    def test_wallet_info(self, mock_post):
        self.mock_response.json.return_value = {
    ...
    @patch('requests.Session.post')
    def test_ledger(self, mock_post):
        self.mock_response.json.return_value = {
    ...
    @patch('requests.Session.post')
    def test_account_info_request_exception(self, mock_post):
    ...
    @patch('requests.Session.post')
    def test_key_expand_request_exception(self, mock_post):
        mock_post.side_effect = requests.exceptions.RequestException("Mocked exception")
        with self.assertRaises(requests.exceptions.RequestException):
